...
namespace Ejercicio36_Library
{
    ...
    public class Competencia<T> where T : VehiculoDeCarrera
    {
                    ...
                    case TipoCompetencia.F1:
                        {
                            ...
                            { throw new CompetenciaNoDisponibleException("Vehiculo no corresponde a competencia de Autos", new Exception()); }
                            break;
                        }
                    case TipoCompetencia.Motos:
                        {
                            ...
                            { throw new CompetenciaNoDisponibleException("Vehiculo no corresponde a competencia de Motos", new Exception()); }
                            break;
                        }
                    default:
                        break;
        ...
        public static Boolean operator !=(Competencia<T> c, T a)
        {
            Boolean retorno = false;
            try { retorno = !(c == a); }
            catch (CompetenciaNoDisponibleException e) { throw e; }
            return retorno;
        }
